    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
            <div className="bg-white p-8 md:p-10 rounded-xl shadow-2xl w-full max-w-md border border-gray-200 transform hover:scale-105 transition duration-300 ease-in-out">
                ...
                <p className="text-center text-gray-600 mb-6">Log in to your BookReviewHub.</p>
                ...
                <p className="text-center text-gray-600 mt-8 text-sm">
                    ...
                    <Link to="/register" className="font-semibold text-blue-600 hover:text-blue-800 transition duration-300 hover:underline">
                        Register here
                    </Link>
                </p>
            </div>
